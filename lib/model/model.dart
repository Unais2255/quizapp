...
//
//     final pepsi = pepsiFromJson(jsonString);

import 'dart:convert';

List<QuestionList> pepsiFromJson(String str) => List<QuestionList>.from(
    json.decode(str).map((x) => QuestionList.fromJson(x)));

String pepsiToJson(List<QuestionList> data) =>
